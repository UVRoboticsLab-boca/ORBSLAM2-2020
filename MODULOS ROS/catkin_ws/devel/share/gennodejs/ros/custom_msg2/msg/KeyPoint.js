...
class KeyPoint {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('idKeypoint')) {
        this.idKeypoint = initObj.idKeypoint
      }
      else {
        this.idKeypoint = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [idKeypoint]
    bufferOffset = _serializer.int32(obj.idKeypoint, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [idKeypoint]
    data.idKeypoint = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.idKeypoint !== undefined) {
      resolved.idKeypoint = msg.idKeypoint;
    }
    else {
      resolved.idKeypoint = 0
    }
