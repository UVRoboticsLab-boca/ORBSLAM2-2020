...
(cl:defmethod cl:initialize-instance :after ((m <Point2f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msg-msg:<Point2f> is deprecated: use custom_msg-msg:Point2f instead.")))
...
(cl:defmethod y-val ((m <Point2f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg-msg:y-val is deprecated.  Use custom_msg-msg:y instead.")
  (y m))
