...
(cl:defclass <KeyPoint> (roslisp-msg-protocol:ros-message)
  ((pt
    :reader pt
    :initarg :pt
    :type custom_msg-msg:Point2f
    :initform (cl:make-instance 'custom_msg-msg:Point2f))
   (size
    :reader size
    :initarg :size
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <KeyPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msg-msg:<KeyPoint> is deprecated: use custom_msg-msg:KeyPoint instead.")))

(cl:ensure-generic-function 'pt-val :lambda-list '(m))
(cl:defmethod pt-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg-msg:pt-val is deprecated.  Use custom_msg-msg:pt instead.")
  (pt m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg-msg:size-val is deprecated.  Use custom_msg-msg:size instead.")
  (size m))
...
(cl:defmethod response-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg-msg:response-val is deprecated.  Use custom_msg-msg:response instead.")
  (response m))

(cl:ensure-generic-function 'octave-val :lambda-list '(m))
(cl:defmethod octave-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg-msg:octave-val is deprecated.  Use custom_msg-msg:octave instead.")
  (octave m))

(cl:ensure-generic-function 'class_id-val :lambda-list '(m))
(cl:defmethod class_id-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg-msg:class_id-val is deprecated.  Use custom_msg-msg:class_id instead.")
  (class_id m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<KeyPoint>)))
  ...
  (cl:format cl:nil "custom_msg/Point2f pt~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%~%~%================================================================================~%MSG: custom_msg/Point2f~%float32 x~%float32 y~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'KeyPoint)))
  "Returns full string definition for message of type 'KeyPoint"
  (cl:format cl:nil "custom_msg/Point2f pt~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%~%~%================================================================================~%MSG: custom_msg/Point2f~%float32 x~%float32 y~%~%~%~%"))
