...
(cl:defclass <custom_msg> (roslisp-msg-protocol:ros-message)
  ((points
    :reader points
    :initarg :points
    :type (cl:vector custom_msg-msg:KeyPoint)
   :initform (cl:make-array 0 :element-type 'custom_msg-msg:KeyPoint :initial-element (cl:make-instance 'custom_msg-msg:KeyPoint))))
)
...
(cl:defmethod points-val ((m <custom_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg-msg:points-val is deprecated.  Use custom_msg-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <custom_msg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'custom_msg-msg:KeyPoint))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<custom_msg>)))
  ...
  "6ad34cde040acacc9804ee0e0a8850d5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'custom_msg)))
  "Returns md5sum for a message object of type 'custom_msg"
  "6ad34cde040acacc9804ee0e0a8850d5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<custom_msg>)))
  ...
  (cl:format cl:nil "custom_msg/KeyPoint[] points~%~%================================================================================~%MSG: custom_msg/KeyPoint~%custom_msg/Point2f pt~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%~%~%================================================================================~%MSG: custom_msg/Point2f~%float32 x~%float32 y~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'custom_msg)))
  "Returns full string definition for message of type 'custom_msg"
  (cl:format cl:nil "custom_msg/KeyPoint[] points~%~%================================================================================~%MSG: custom_msg/KeyPoint~%custom_msg/Point2f pt~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%~%~%================================================================================~%MSG: custom_msg/Point2f~%float32 x~%float32 y~%~%~%~%"))
