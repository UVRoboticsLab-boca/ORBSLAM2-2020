...
(cl:defmethod cl:initialize-instance :after ((m <Point2f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msg2-msg:<Point2f> is deprecated: use custom_msg2-msg:Point2f instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Point2f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg2-msg:x-val is deprecated.  Use custom_msg2-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Point2f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg2-msg:y-val is deprecated.  Use custom_msg2-msg:y instead.")
  (y m))
