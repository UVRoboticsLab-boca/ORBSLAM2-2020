...
"""autogenerated by genpy from custom_msg/KeyPoint.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import custom_msg.msg

class KeyPoint(genpy.Message):
  _md5sum = "11cefb08bec6034bef3e32ec473dc6a7"
  _type = "custom_msg/KeyPoint"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """custom_msg/Point2f pt
float32 size
float32 angle
float32 response
int32 octave
...
"""
  ...
  _slot_types = ['custom_msg/Point2f','float32','float32','float32','int32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pt is None:
        self.pt = custom_msg.msg.Point2f()
